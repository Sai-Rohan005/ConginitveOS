...
class DeterministicDebugger:
    ...
    def _install_dependency(
        ...
        try:
            ...
            return False# domains/softwareEngineering/agents/debug_agent.py
...
class DebugAgent:
    ...
    """
    Hybrid deterministic + LLM debugger.
    """
...
ONLY analyze COMPLEX failures.

Deterministic failures are already handled.

Your job:
- analyze architecture flaws
